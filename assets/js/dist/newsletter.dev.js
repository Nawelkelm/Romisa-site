  ...
  ajax.onreadystatechange = function () {
    if (this.readyState == 4) {
      if (this.status == 200) {
        ...
        document.getElementById('subscribe-message').innerHTML = 'Error en el servidor.';
      }
    }
  };

  ajax.onerror = function () {
    document.getElementById('subscribe-message').innerHTML = 'Error en la solicitud AJAX.';
  };
